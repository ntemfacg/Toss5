...
public class bin extends Fragment {
    ...
    public void onStart() {
        ...
        mWindowManager = (WindowManager) getActivity().getSystemService(getActivity().WINDOW_SERVICE);
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        class ParticleSystem {
            ...
            ParticleSystem() {
                ...
                for (int i = 0; i < mBalls.length; i++) {
                    ...
                    mBalls[i].setBackgroundResource(R.drawable.four);
            ...
            public void update(float sx, float sy, long now) {
                ...
                boolean more = true;
                final int count = mBalls.length;
                for (int k = 0; k < NUM_MAX_ITERATIONS && more; k++) { //remove && more
                    more = false;
                    for (int i = 0; i < count; i++) {
        ...
        public void startSimulation() {
            /*
             * It is not necessary to get main events at a very high
        ...
        public void onSensorChanged(SensorEvent event) {
            if (event.sensor.getType() != Sensor.TYPE_ACCELEROMETER)
                return;
            /*
             * record the main data, the event's timestamp as well as
        ...
        protected void onDraw(Canvas canvas) {
            /*
             * Compute the new position of our object, based on main
